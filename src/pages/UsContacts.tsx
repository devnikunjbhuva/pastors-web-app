...
import { UsContactsProps } from "../utils/interface/us-contacts.interface";
import { Pagination } from "../utils/constants";
import { Filter } from "../utils/enumeration/filter.enum";
import { handleChanges } from "../utils/common-functions";

const UsContacts = ({ closeModal, openModal }: UsContactsProps) => {
          ...
          <button
            ...
            <div className="form-check">
              <input
                ...
                onChange={(event) =>
                  handleChanges("isShowEven", event?.target?.checked, setContactForm)
                }
                id="showEven"
              />
